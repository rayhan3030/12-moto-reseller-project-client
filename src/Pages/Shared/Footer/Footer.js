...
const Footer = () => {
    return (
        <footer className="footer footer-center  bg-base-200 text-base-content rounded mt-32 max-h-screen ">
            ...
            <div>
                <div><span className='text-6xl'>🏍️</span></div>
                <p>Copyright © 2022 - All right reserved by Moto Reseller</p>
            </div>
        </footer>
    );
};
